...
namespace maealim.Migrations
{
    ...
    [Migration("20200305173958_Attends")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("maealim.Models.Attend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("maealim.Models.TypesMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("maealim.Models.WjhaaMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("TypesMessageId");

                    b.ToTable("WjhaaMessages");
                });
            ...
            modelBuilder.Entity("maealim.Models.Attend", b =>
                {
                    ...
                    b.HasOne("maealim.Models.EmployeeContract", "EmployeeContract")
                        .WithMany("Attends")
                    ...
                    b.HasOne("maealim.Models.GuideContract", "GuideContract")
                        .WithMany("Attends")
            ...
            modelBuilder.Entity("maealim.Models.WjhaaMessage", b =>
                {
                    ...
                    b.HasOne("maealim.Models.TypesMessage", "TypesMessage")
                        .WithMany("WjhaaMessage")
                        .HasForeignKey("TypesMessageId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
